...
public class Financepage {
	...
	@FindBy(xpath="//label[@for='AccountNo']") WebElement PostPayment_AccountNolbl;
	@FindBy(xpath="//input[@id='AccountNo']") WebElement PostPayment_AccountNo;
	@FindBy(xpath="//label[@for='FleetNbr']") WebElement Installment_FleetNolbl;
...
ElementUtil.waitUntilElementsVisible(Fee_Headers);
	...
	public String Fetch_PostPayment_AccountNolbl() {
		return ElementUtil.FetchTextBoxValuewithText(PostPayment_AccountNolbl);
	}
	public String Fetch_PostPayment_AccountNo() {
		return ElementUtil.FetchTextBoxValuewithattribute(PostPayment_AccountNo,"value");
	}
	public String Fetch_FleetNolbl() {
		return ElementUtil.FetchTextBoxValuewithText(Installment_FleetNolbl);
	}
